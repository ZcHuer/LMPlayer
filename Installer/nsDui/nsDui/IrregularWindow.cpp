...
bool CIrregularWindow::RegisterWindowClass()
{
	...
	wc.hIcon = LoadIconW(wc.hInstance, MAKEINTRESOURCE(IDI_ICON_INSTALL));
	//wc.hIconSm = LoadIconW(wc.hInstance, MAKEINTRESOURCE(IDI_ICON_INSTALL));
...
{
	m_hWnd = ::CreateWindowEx(WS_EX_LAYERED, __className, _T("联想视频"),WS_OVERLAPPEDWINDOW,
