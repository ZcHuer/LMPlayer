...
CC_IDENT=gcc 6.3.0 (MinGW.org GCC-6.3.0-1)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=_
CC=gcc
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__MSVCRT_VERSION__=0x0700 -D_WIN32_WINNT=0x0600 -D__printf__=__gnu_printf__
CFLAGS=   -std=c11 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
HOSTCPPFLAGS= -D_ISOC99_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__MSVCRT_VERSION__=0x0700 -D_WIN32_WINNT=0x0600 -D__printf__=__gnu_printf__
HOSTEXESUF=.exe
HOSTLDFLAGS= 
HOSTEXTRALIBS=-lm
DEPHOSTCC=gcc
...
EXTRALIBS-avcodec=-liconv -lm
EXTRALIBS-avdevice=-lgdi32 -lm -lvfw32
EXTRALIBS-avfilter=-lm
EXTRALIBS-avformat=-lm -lws2_32
EXTRALIBS-avresample=-lm
EXTRALIBS-avutil=-lm -luser32
