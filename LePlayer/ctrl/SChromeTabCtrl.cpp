...
namespace SOUI
{
    ...
    SChromeTab * SChromeTabCtrl::GetChromeTab(int iTabIndex) const
    {
        if (iTabIndex>=0&& iTabIndex<m_lstTabOrder.GetCount())
        {
            return m_lstTabOrder[iTabIndex];
        }
        return nullptr;
    }
}