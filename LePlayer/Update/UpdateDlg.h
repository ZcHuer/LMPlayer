...
protected:
    ...
    BEGIN_MSG_MAP_EX(SUpdateDlg)
		...
		MESSAGE_HANDLER_EX(eUPDATE_Download_Success, WndPro)		
		MESSAGE_HANDLER_EX(eUPDATE_Download_Error, WndPro)
		MESSAGE_HANDLER_EX(eUPDATE_Unzip_Success, WndPro)		
		MESSAGE_HANDLER_EX(eUPDATE_Unzip_Error, WndPro)
